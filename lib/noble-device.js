...
NobleDevice.prototype.onDisconnect = function(reason) {
  this.connectedAndSetUp = false;
  this._services = {};
  this._characteristics = {};
...
NobleDevice.prototype.connect = function(callback, options) {
...
NobleDevice.prototype.connectAndSetUp = NobleDevice.prototype.connectAndSetup = function(callback, options) {
